...
export default function page() {
  return (
    <>
      <Home
        title="About"
        src="https://previews.123rf.com/images/vska/vska1604/vska160400081/55577688-abstract-tech-background-futuristic-interface-vector-illustration-with-many-geometric-shape-.jpg"
      />
      <Box>
        <Container maxW={1400}>
          <Flex
          ...
          >
            <Box flexBasis="50%">
              <Image
                ...
                alt="President"
                mx="auto"
                pt={{ lg: "30px", base: "10px" }}
              />
            </Box>
            <Box flexBasis="50%">
              <Heading size={{ lg: "2xl", base: "xl" }}>Dr. Arif Alvi</Heading>
              <Text mt={5}>
      ...
      <Box>
        <Container maxW={1400}>
          ...
          >
            <Box flexBasis="50%">
              <Heading size={{ lg: "2xl", base: "xl" }}>Panaverse DAO</Heading>
              <Text mt={5}>
      ...
      <Box>
        <Container maxW={1400}>
          ...
          >
            <Box flexBasis="50%">
              <Image src="/zia.png" alt="ziasir" m="auto" pt="50px" />
            </Box>
            <Box flexBasis="50%">
              <Heading size={{ lg: "2xl", base: "xl" }}>Zia Khan</Heading>
              <Text mt={5}>
                ...
                computing mass education. Mentor and software developer with 20 plus
