...
export default function Banner() {
  return (
    <>
      <Box
        pb="30px"
        bgImage="https://rare-gallery.com/uploads/posts/543364-digital-art.jpg"
      >
        <Container maxW={1400}>
          <Flex
            gap="35px"
            pt={{ lg: "70px", base: "30px" }}
            pb={{ lg: "70px", base: "0" }}
            px={{ lg: "40px", base: "5px" }}
          ...
          >
            <Box
              ...
              px={{ lg: "40px", base: "0px" }}
            >
              <Heading pb="10px" color="white" fontSize="5xl">
          ...
          >
            <Box flexBasis="50%">
              <Image
                src="/logo3.png"
                alt="Panaverse-logo"
                width={{ lg: "350", base: "200" }}
                height={{ lg: "550", base: "400" }}
              ></Image>
            </Box>
            <Box
              flexBasis="50%"
              pt={{ lg: "130px", base: "0px" }}
              px={{ lg: "0", base: "5px" }}
              pb={{ lg: "0px", base: "10px" }}
            >
          ...
          >
            ...
            >
              <Heading
                ...
                pt={{ lg: "130px", base: "20px" }}
              >
                What Is Panaverse DAO?
              </Heading>
              <Text pb={{ lg: "10px", base: "5px" }}>
              ...
              <Link href="/about">
                <Button mt="10px" size="md" colorScheme="teal">
                  {" "}
                  Read More
                </Button>
              </Link>
            ...
            <Box flexBasis="50%">
              <Image
                src="/pd.png"
                alt="Panavers Dao"
                width={{ lg: "350", base: "300" }}
                height={{ lg: "450", base: "300" }}
              />
            </Box>
          </Flex>
        </Container>
